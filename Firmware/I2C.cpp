...
void setCurrent( int chg_typ )         //decide current capability of charger, and send to charger
{
    ...
    case 2000:
        configCharger( 0b01010100, 0b11110100 );   //sets input current to 2000 and enables charging
        break;

    case 1500:
        configCharger( 0b01000100, 0b10010100 );   //sets input current to 1500 and enables charging
        break;
